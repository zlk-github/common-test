...
public class ConsumerTagListener2 implements RocketMQListener<MessageExt> , RocketMQPushConsumerLifecycleListener {
    ...
    public void onMessage(MessageExt messageExt) {
        ...
        log.info("tag2过滤消息。拿到消费组：{}，consumerGroup：{}，主题Top:{}下消息,tag:{},消息：{}","rocketmq_consumer_group_1007_2",groupName,RocketMQConstant.TOPIC_7,messageExt.getTags(),message);
    }

    @SneakyThrows
    @Override
    public void prepareStart(DefaultMQPushConsumer defaultMQPushConsumer) {
        // 过滤获取到RocketMQConstant.TOPIC_7下tag:tag2
        //defaultMQPushConsumer.subscribe(RocketMQConstant.TOPIC_7_2,RocketMQConstant.TAG_2);
        // 设置最大重试次数
