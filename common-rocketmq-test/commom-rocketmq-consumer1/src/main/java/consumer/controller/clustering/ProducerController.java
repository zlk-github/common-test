package consumer.controller.clustering;
    ...
    public void syncSend(@RequestParam String msg){
        try {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                sbf.append("-");
                sbf.append(index);
                Message message = new Message(RocketMQConstant.CLUSTERING_TOPIC, RocketMQConstant.CLUSTERING_TAG, sbf.toString().getBytes());
